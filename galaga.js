     ...
     window.onload = function () 
     {
         ...
         enemy_img = new Image();
         enemy_img.src = "./Galaga/enemy.png";
     ...
     function game ()
     {
         if (left_key) {player_x -= width/100;}
         if (right_key) {player_x += width/100;}

         if (player_x > width - (player_width/2)) {player_x = -player_width/2}
         if (player_x < -player_width/2) {player_x = width - (player_width/2)}
